        ...
        for resource_id in os.listdir(resource_folder):
            ...
            for version in versions:
                ...
                with open(version_file, "r") as f:
                    ...
                    assert isinstance(global_post_bundle_2["entry"], list)
                    assert isinstance(global_post_bundle_2["total"], int)

                    global_post_bundle_2["entry"].append(entry_2)
                    global_post_bundle_2["total"] += 1
                break
    with open(os.path.join(base_path, "post_resources.json"), "w") as f:
        json.dump(global_post_bundle, f, indent=4)
    with open(os.path.join(base_path, "post_resources_2.json"), "w") as f:
        json.dump(global_post_bundle_2, f, indent=4)
