...
from app.services.update.update_consumer_service import UpdateConsumerService, McsdResources
...
def test_cleanup() -> None:
    ...
    def mock_resource_map_service_find(
        ...
        return [
            MagicMock(supplier_id=supplier_id, consumer_resource_id="resource_1", resource_type=resource_type),
            MagicMock(supplier_id=supplier_id, consumer_resource_id="resource_2", resource_type=resource_type),
        ]
    ...
    service._UpdateConsumerService__consumer_fhir_api = mock_consumer_fhir_api # type:ignore

    service.cleanup(supplier_id)

    mock_resource_map_service.find.assert_called_with(supplier_id=supplier_id, resource_type=ANY)
