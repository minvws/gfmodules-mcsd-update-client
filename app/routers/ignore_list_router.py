...
from app.container import get_supplier_ignored_directory_service
...
def find(
    service: SupplierIgnoredDirectoryService = Depends(get_supplier_ignored_directory_service),
) -> Response:
