...
class UpdateClientService:
    ...
    def __flush_delete_bundle(self, bundle: Bundle, directory_id: str) -> None:
        if bundle.total is not None and bundle.total > 0:
            ...
            # TODO: Check outcomes for failures, 
            # The bundle could be full of operation outcomes indicating failures
            # Try the failed again, store for later or log them
            # No check is being done to actually verify the response
