...
class SupplierInfoService:
    def __init__(self, database: Database, supplier_directory_ignore_service: SupplierDirectoryIgnoreService, supplier_stale_timeout_seconds: int) -> None:
    ...
    def health_check(self) -> bool:
        ...
        filtered_suppliers = self.__supplier_directory_ignore_service.filter_ignored_supplier_info(self.get_all_suppliers_info())
        return all([
