...
class Node(BaseModel):
    ...
    visited: bool = False
    updated: bool = False
    supplier_hash: int | None = None  # we do not need this
    consumer_hash: int | None = None  # we do not need this
    resource_map: ResourceMapDto | None = None
    update_status: Literal["ignore", "equal", "delete", "update", "new", "unknown"] = (
        "unknown"
    )
    references: List[NodeReference] = []
    update_data: NodeUpdateData = NodeUpdateData()
